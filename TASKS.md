...
- [ ] 0.1.0 Utworzyc projekt `LaserCad.Core`.
...
- [ ] 0.2.0 Ustalic konwencje namespace, np. `LaserCad.Geometry`.
...
- [ ] 0.3.4 Dodac wlasciwosc `Millimeters`.
- [ ] 0.3.5 Dodac operatory dodawania i odejmowania `Length`.
